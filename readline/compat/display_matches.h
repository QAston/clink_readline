...
READLINE_API rl_match_display_filter_func_t *rl_match_display_filter_func;

READLINE_API const char *_rl_filtered_color;

READLINE_API void free_filtered_matches(match_display_filter_entry** filtered_matches);
READLINE_API void display_matches(char **matches);
